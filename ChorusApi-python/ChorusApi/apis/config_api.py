...
class ConfigApi(object):
    ...
    def v_ersion_get(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method v_ersion_get" % key)
            params[key] = val
        del params['kwargs']
    ...
    def config_get(self, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s' to method config_get" % key)
            params[key] = val
        del params['kwargs']
